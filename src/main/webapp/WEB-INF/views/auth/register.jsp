            ...
            <div class="auth-wrapper">
                <div class="auth-image">
                    <div class="auth-image-content">
                        ...
                        <p>Registration is the first step towards a legacy of life. Choose your role and join our
                            mission today.</p>
                    </div>
                </div>
                        ...
                        <c:if test="${not empty param.error}">
                            <div class="alert alert-danger" style="margin-bottom: 24px;">
                                <c:choose>
                                    ...
                                    <c:when test="${param.error == 'email Duplicate'}">Email is already registered.
                                    </c:when>
                            ...
                            <%-- Step 1: Role Selection --%>
                                <div class="form-group" id="roleStep">
                                    ...
                                    <select name="role" id="roleSelect" required
                                        style="font-size: 1.1rem; height: 50px; border-width: 2px;">
                                ...
                                <div id="commonFields" class="hidden-fields">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="phone" maxlength="10" placeholder="10-digit mobile"
                                            required />
                                    </div>
                                    ...
                                    <%-- Member Specific --%>
                                        ...
                                        <%-- Hospital Specific --%>
                                            ...
                                            <button type="submit" class="btn btn-primary btn-full"
                                                style="margin-top: 12px;">Complete Registration</button>
                                </div>
                        </form>
