<%-- WEB-INF/views/hospital/completed.jsp --%>
...
<div class="app-wrapper">
    ...
    <main class="main-content">
        ...
        <div class="card">
            <table class="data-table" id="doneTable">
                <thead>
                    <tr>
                        <th>ID</th>
                        <th>Member</th>
                ...
                <tbody>
                    <c:forEach items="${requests}" var="r">
                        <tr>
                            ...
                            <td><fmt:formatDate value="${r.resolvedAt}" pattern="dd MMM yyyy"/></td>
                        </tr>
                    </c:forEach>
                    <c:if test="${empty requests}">
                        <tr><td colspan="6" class="text-center">No completed transplants yet.</td></tr>
                    </c:if>
                </tbody>
            </table>
        </div>
