    ...
    <div class="auth-wrapper">
        <div class="auth-image">
            <div class="auth-image-content">
                <h1>A Gift of Life <br> from the Himalayas.</h1>
                <p>Registration is the first step towards a legacy of life in Nepal. Choose your role and join our mission today.</p>
            </div>
        </div>
