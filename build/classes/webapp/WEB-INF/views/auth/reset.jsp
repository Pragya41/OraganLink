    ...
    <div class="auth-wrapper">
        <div class="auth-image">
            <div class="auth-image-content">
                <h1 class="outfit">Nepal Health <br> Security.</h1>
                <p>We're here to help you regain access to your account securely. Follow the multi-factor verification steps as per Nepal's health authority standards.</p>
            </div>
        </div>
